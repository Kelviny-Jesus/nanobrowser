...
export const defaultTemplates = [
  {
    ...
    content:
      "Open the NB1 repository at https://github.com/NB1/NB1 and check if you've already starred it. If not, please support us by giving us a star!",
  },
  {
    id: '2',
    title: '🐦 Follow us on X/Twitter!',
    content: 'Follow us at https://x.com/NB1_ai to stay updated on the latest news and features!',
  },
  {
    id: '3',
